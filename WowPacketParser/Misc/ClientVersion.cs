...
namespace WowPacketParser.Misc
{
    public static class ClientVersion
    {
        ...
        private static readonly KeyValuePair<ClientVersionBuild, DateTime>[] ClientBuilds = {
            ...
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V8_3_0_33051, new DateTime(2020, 01, 14, 16, 20, 00)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V8_3_0_33062, new DateTime(2020, 01, 14, 20, 25, 00)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V8_3_0_33073, new DateTime(2020, 01, 17)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V8_3_0_33084, new DateTime(2020, 01, 18)),
        ...
        public static ClientVersionBuild GetVersionDefiningBuild(ClientVersionBuild build)
        {
            switch (build)
            {
                ...
                case ClientVersionBuild.V8_3_0_33051:
